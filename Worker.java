...
public class Worker extends Node {
	...
	public static int workerPort = 50003; // Port of the worker
	static int workerVersion = 1;
	...
	public Worker(Terminal Terminal, String dstHost, int dstPort, int srcPort) 
	{
		try {
			name = "unnamed";
	...
	public void start(Worker worker) throws Exception 
	{
		try {
...
//		}
	...
	{
		Worker workerOne = new Worker(terminal, DEFAULT_DST_NODE, DEFAULT_DST_PORT, workerPort);
		try {
