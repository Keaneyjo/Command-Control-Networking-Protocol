...
public class WorkerThree extends Node {
	...
	public static int workerPort = 50005; // Port of the worker
	static int workerVersion = 3;
	...
	public WorkerThree(Terminal Terminal, String dstHost, int dstPort, int srcPort) 
	{
		try {
			name = "unnamed";
	...
	public void start(WorkerThree worker) throws Exception 
	{
		try {
...
//		}
	...
	{
		WorkerThree workerOne = new WorkerThree(terminal, DEFAULT_DST_NODE, DEFAULT_DST_PORT, workerPort);
		try {
